...
const actions = {
  ...
  setDatas({ commit }) {
    ...
    let data = {
      contentImgSrc: [{
          imgSrc: 'http://dummyimage.com/600x600/5a9e6e/FFF.png'
        },
        {
          imgSrc: 'http://dummyimage.com/600x600/5a9e6e/FFF.png'
        },
      ...
      swiper: [{
          id: 16161616,
          imgSrc: 'http://dummyimage.com/400x400/ffcc33/FFF.png'
        },
        {
          id: 6161616,
          imgSrc: 'http://dummyimage.com/400x400/ffcc33/FFF.png'
      ...
      view: {
        title: '三星 Galaxy S8 移动联通电信4G手机 ',
        intro: '石五他高何军动她受边温江局度。三自省件器产程感算联本劳还层火族。',
        id: '410000201312295694',
        price: 108,
        chose: [{
            col: '土豪金',
            size: '128g'
